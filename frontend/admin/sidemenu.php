...
<div class="sidebar">
            ...
            <ul class="sidemenu-list">
                ...
                <li>
                    <a href="newEvent.php"><i class="bx bxs-user-pin"></i>&nbsp; Add Event</a>
                </li>
                <li>
                    <a href="partners.php"><i class='bx bxs-category-alt'></i>&nbsp;View Partners</a>
                </li>
                <li>
                    <a href="newPartner.php"><i class='bx bxs-category-alt'></i>&nbsp;Add Partner</a>
                </li>
