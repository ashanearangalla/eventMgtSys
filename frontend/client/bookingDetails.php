...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$isSelected) {
        $_SESSION['message'] = "Please select at least one ticket.";
        header("Location: viewEvent.php?eventID=" . $_POST['eventID']);
        exit;
    }
}
...
<body class="payment-section-booking">
<?php include("../header.php") ?> 
    <section class="payment-section">
    <h1 class="payment-title">Booking Details</h1>
        <div class="payment-container">
            
            <div class="billing-details-booking">
